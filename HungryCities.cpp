...
PlayerCity * HungryCitiesGame::cityInitialization(std::string mobileCityImage, std::string staticCityImage)
{
    ...
    //AICity * targetCity5 = new AICity("C5", 90,  mobileCityImage, 600, 2700, 2700);
    //AICity * targetCity6 = new AICity("C6", 90,  mobileCityImage, 600, 2700, 2500);
    AICity * targetCity7 = new AICity("C7", 70,  mobileCityImage, 600, 2700, 2300);
    ...
    AICity * targetCity13 = new AICity("C13", 70,  mobileCityImage, 600, 2300, 2300);
